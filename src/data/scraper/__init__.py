...
from src.data.scraper.holdings_scraper import HoldingsScraper
from src.data.scraper.news_scraper import NewsScraper
from src.data.scraper.research_scraper import ResearchScraper
