...
if run_btn:
    ...
    with chart_col1:
        ...
        fig1 = go.Figure()
        fig1.add_trace(go.Scatter(x=dates, y=df_plot['operating_cash_flow'], mode='lines+markers', name='经营现金流', line=dict(color='#1f77b4', width=2)))
        fig1.add_trace(go.Scatter(x=dates, y=-df_plot['capex'], mode='lines+markers', name='资本支出(-)', line=dict(color='#ff7f0e', width=2, dash='dash')))
        ...
        fig1.update_layout(hovermode="x unified", margin=dict(t=20, b=20, l=20, r=20), legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
    ...
    with chart_col2:
        ...
        fig2.update_layout(barmode='group', hovermode="x unified", margin=dict(t=20, b=20, l=20, r=20), legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
    ...
    with chart_col3:
        ...
        fig3 = go.Figure()
        fig3.add_trace(go.Scatter(x=dates, y=df_plot['fcf_margin'], mode='lines+markers', name='FCF利润率', line=dict(color='#9467bd', width=3)))
        ...
        fig3.update_layout(hovermode="x unified", margin=dict(t=20, b=20, l=20, r=20), yaxis_title="百分比 (%)")
